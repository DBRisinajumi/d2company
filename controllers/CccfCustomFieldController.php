...
class CccfCustomFieldController extends Controller
{
	/**
	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				...
				'roles'=>array('Customer.fullconfrol'),
			),
	...
	{
		$dataProvider=new CActiveDataProvider('BaseCccfCustomField');
	...
	{
		$model=new BaseCccfCustomField('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['BaseCccfCustomField']))
			$model->attributes=$_GET['BaseCccfCustomField'];
	 ...
	 * @param BaseCccfCustomField $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='base-cccf-custom-field-form')
		{
