...
abstract class BaseCcbrBranch extends CActiveRecord
{
    ...
    public function search($criteria = null)
    {
        ...
        $criteria->compare('t.ccbr_code', $this->ccbr_code, true);
