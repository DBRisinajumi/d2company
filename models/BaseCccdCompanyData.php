...
class BaseCccdCompanyData extends UActiveRecord
{
	/**
	 * The followings are the available columns in table 'cccd_custom_data':
	 * @var integer $cccd_ccmp_id
	 * @var boolean $regMode
	 */
	...
	public function relations()
	{
		...
		$relations = array(
			'ccmpCompany'=>array(self::HAS_ONE, 'ccmp_company', 'cccd_ccmp_id'),
		);
	...
	{
		$labels = array(
			'cccd_ccmp_id' => UserModule::t('User ID'),
		);
		$model=self::getFields();
