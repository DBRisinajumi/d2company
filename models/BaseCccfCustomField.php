...
class BaseCccfCustomField extends CActiveRecord
{
	const VISIBLE_ALL=3;
	...
	/**
	 * The followings are the available columns in table 'cccf_custom_fields':
	 * @var integer $id
	 * @var string $varname
	 * @var string $title
...
//            ),
    ...
    public function search()
    {
        ...
        $criteria->compare('cccf_id',$this->id);
